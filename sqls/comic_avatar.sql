...
CREATE TABLE `comics` (
  ...
  `channel` int(11) UNSIGNED NOT NULL DEFAULT '0' COMMENT '枚举值：0.未知 1.腾讯漫画 2.漫画牛',
  `source_id` int(11) UNSIGNED NOT NULL DEFAULT '0' COMMENT '对应渠道资源ID',
  ...
  `max_sequence` int(10) UNSIGNED DEFAULT '0' COMMENT '对应漫画当前的最大阅读序号。对应comic_pages.sequence的对应最大值',
  `weight` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT '权重值.值越大,越靠前展示',
  `tag` tinyint(5) UNSIGNED NOT NULL DEFAULT '0' COMMENT '标记。枚举值: 0->没有标记,1->热门,2->连载,3->完结',
  `ext_1` varchar(50) NOT NULL DEFAULT '' COMMENT '扩展字段1，针对不同情况使用',
  `ext_2` varchar(50) NOT NULL DEFAULT '' COMMENT '扩展字段2，针对不同情况使用',
  `ext_3` varchar(50) NOT NULL DEFAULT '' COMMENT '扩展字段3，针对不同情况使用',
...
(7, 2, 4419, '偷星九月天', 'https://restp.dongqiniqin.com/images/cover/201804/1524371582VN_mppKONpcP64E6.jpg', '一场爱与梦想的奇妙冒险…… 是男仆还是热血的少年侦探？江洋大盗竟是如花美眷？！ 迷雾一层接一层，悬念...', '3', '', '', 2, 1, 1, 0, '2019-09-14 12:35:09', '2019-09-13 12:43:58'),
(8, 2, 3232, '全职法师', 'https://restp.dongqiniqin.com/images/cover/201805/1526863299TscidLRww7sSpNI2.jpg', '周三、周五、周六上午10点准时更新！官方1群号：598116890 官方2群号：637220919 ...', '1', '', '', 1, 1, 1, 0, '2019-09-16 14:57:27', '2019-09-16 14:53:23');